...
echo "→ 编译 Swift…"
mkdir -p "$BINDIR"
run_swiftc -parse-as-library main.swift AppConfig.swift MenuPresentation.swift VpnctlClient.swift TunnelReducer.swift -o "$BINDIR/$APPNAME" -framework Cocoa -framework ServiceManagement
